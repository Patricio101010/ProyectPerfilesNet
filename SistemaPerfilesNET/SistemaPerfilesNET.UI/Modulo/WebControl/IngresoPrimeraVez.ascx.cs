...
{
    public partial class IngresoPrimeraVez : System.Web.UI.UserControl
    {
        ...
        readonly string Interfaz = "IngresoPrimeraVez", MensajeError = "Se ha producido un error en el sistema. Por favor, comunícate con el soporte técnico si el problema persiste. Lamentamos las molestias.";
        ...
        protected void BtnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ObjUsuarioBLL.ValidaModificarContrasenna(Usuario, txtPasswordNueva1.Text, out MensajeValidacion, UserIP, "", true))
                {
                    ClsMensaje.MensajeModal(UpdatePanel1, Page.Title, MensajeValidacion, ClsMensaje.TipoMensaje._Exclamacion);
                    Modal_PrimeraVez.Show();
                    return;
                ...
                if (ObjUsuarioBLL.ModificarContrasenna(Usuario, txtPasswordNueva1.Text, false))
                {
            ...
            {
                ClsMensaje.MensajeModal(UpdatePanel1, Page.Title, MensajeError, ClsMensaje.TipoMensaje._Exclamacion);
                ObjLog.ArchivoLog(Interfaz, Method, ex);
                Modal_PrimeraVez.Show();
            }
        }
        ...
        private bool ValidaCamposContrasenna(out string MensajeValidacion)
        {
            ...
            if (!txtPasswordNueva1.Text.Equals(txtPasswordNueva2.Text))
            {
            ...
            if (VerificarContrasenna(txtPasswordNueva1.Text, out MensajeValidacion))
                return true;
