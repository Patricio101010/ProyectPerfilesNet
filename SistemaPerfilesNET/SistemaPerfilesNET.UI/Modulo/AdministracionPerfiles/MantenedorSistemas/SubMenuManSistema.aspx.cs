...
namespace SistemaPerfilesNET.UI.Modulo.AdministracionPerfiles.MantenedorSistemas
{
    public partial class SubMenuManSistema : System.Web.UI.Page
    {
        ...
        readonly string Interfaz = "SubMenuManSistema", MensajeError = "Se ha producido un error en el sistema. Por favor, comunícate con el soporte técnico si el problema persiste. Lamentamos las molestias.";
        ...
        {
            List<MenuEN> ListaMenu = ObjMenuBLL.GetListaMenuAdministracion(usuarioIN, 1, 13000);
