<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CambioContrasenna.ascx.cs" Inherits="SistemaPerfilesNET.UI.Modulo.WebControl.CambioContrasenna" %>
...
<cc1:ModalPopupExtender
    ID="Modal_CambioContrasenna" runat="server" TargetControlID="LinkMensaje" PopupControlID="UpdatePanel1"
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server" ChildrenAsTriggers="true" UpdateMode="Conditional" style="display: none">
    <ContentTemplate>
        ...
        <asp:Panel ID="Panel" runat="server" Height="300px" Width="450px" BackColor="WhiteSmoke" Style="background: linear-gradient( 20%, 50%,#2888d2 ); border-radius: 10px;">
            <div class="container-fluid">
                <div class="row justify-content-center">
                    ...
                    <div class="col-xl-10" style="height: 200px; width: 450px; border: none;">
                        <div style="margin-top: 20px">
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="mb-3 row">
                                        <p class="h6 col-sm-6 d-flex justify-content-start">Contraseña actual.</p>
                                        <div class="col-sm-5">
                                            <asp:TextBox ID="txtContrasennaActual" runat="server" CssClass="form-control form-control-sm" Enabled="true" TextMode="Password" AutoComplete="off" />
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        <p class="h6 col-sm-6 d-flex justify-content-start">Contraseña nueva.</p>
                                        <div class="col-sm-5">
                                            <asp:TextBox ID="txtPassword1" runat="server" CssClass="form-control form-control-sm" Enabled="true" TextMode="Password" AutoComplete="off" />
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        <p class="h6 col-sm-6 d-flex justify-content-start">Confirmar contraseña.</p>
                                        <div class="col-sm-5">
                                            <asp:TextBox ID="txtPassword2" runat="server" CssClass="form-control form-control-sm" Enabled="true" TextMode="Password" AutoComplete="off" />
                                        </div>
                                    </div>
                                </div>
                            </div>
